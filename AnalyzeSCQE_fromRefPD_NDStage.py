...
if __name__ == "__main__":
    ...
    stems = ['SC_QE_from_mono_SC_ED_', 'SC_QE_from_mono_SC_ED_']
    #stems = ['SC_QE_from_mono_SC_ED_']
    suffixes = ['_singleStream2_straightSource', '_singleStream3_straightSource']
    #suffixes = ['_singleStream1_straightSource']
    date_strs = ['20210610', '20210610']
    #date_strs = ['20210607']
    extra_title_str = 'Cell ID ED, Steady Light'
    cell_ids = ['Cell ED - ' + date_strs[0] + ' 1', 'Cell ED - ' + date_strs[0] + ' 2']
    ...
    for i in range(len(data_files)):
        ...
        wavelengths, stage_positions, SC_illum_times, SC_illum, SC_illum_bv, SC_dark_times, SC_dark, SC_dark_bv, PD_illum_times, PD_illum, PD_illum_bv, PD_dark_times, PD_dark, PD_dark_bv, SC_temps = readInSCandPDDataFile(data_file, data_dir, SC_neg_current, PD_neg_current, ignore_str = deleted_element_id)
        ...
        if plot_wavelengths:
            ...
            x_lims = [0.0, max(local_x_max, x_lims[1])]
