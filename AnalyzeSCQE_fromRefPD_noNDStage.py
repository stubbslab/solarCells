...
def readInSCandPDDataFile(data_file, data_dir, SC_neg_current, PD_neg_current, ignore_str = 'DELETED'):
    ...
    return [wavelengths, SC_ill_times, SC_illum, SC_illum_bv, SC_dk_times, SC_dark, SC_dark_bv, PD_ill_times, PD_illum, PD_illum_bv, PD_dk_times, PD_dark, PD_dark_bv, SC_temps]
...
if __name__ == "__main__":
    ...
    stems = ['SC_QE_from_mono_SC_ED_', 'SC_QE_from_mono_SC_ED_', 'SC_QE_from_mono_SC_ED_', 'SC_QE_from_mono_SC_ED_', 'SC_QE_from_mono_SC_ED_', 'SC_QE_from_mono_SC_ED_']
    #stems = ['SC_QE_from_mono_SC_ED_']
    suffixes = ['_singleStream1_straightSource', '_singleStream2_straightSource', '_singleStream1_straightSource', '_singleStream2_straightSource', '_singleStream1_straightSource', '_singleStream2_straightSource']
    #suffixes = ['_singleStream1_straightSource']
    date_strs = ['20210607', '20210607', '20210608', '20210608', '20210609', '20210609']
    #date_strs = ['20210607']
    extra_title_str = 'Cell ID ED, Steady Light'
    cell_ids = ['Cell ED - ' + date_strs[0] + ' AM',  'Cell ED - ' + date_strs[1] + ' PM', 'Cell ED - ' + date_strs[2] + ' AM', 'Cell ED - ' + date_strs[3] + ' PM', 'Cell ED - ' + date_strs[4] + ' AM', 'Cell ED - ' + date_strs[5] + ' PM']
    #cell_ids = ['Cell ED - ' + date_strs[0] + ' AM']
    shunt_resistances = [610, 610, 610, 610, 610, 610]
    ...
    for i in range(len(data_files)):
        ...
        wavelengths, SC_illum_times, SC_illum, SC_illum_bv, SC_dark_times, SC_dark, SC_dark_bv, PD_illum_times, PD_illum, PD_illum_bv, PD_dark_times, PD_dark, PD_dark_bv, SC_temps = readInSCandPDDataFile(data_file, data_dir, SC_neg_current, PD_neg_current, ignore_str = deleted_element_id)
        ...
        if plot_wavelengths:
            ...
            x_lims = [min(wavelengths), max(wavelengths)]
        else:
...
#axarr_QE[2].legend([SC_QE_plots[0], PD_QE_plots[0], lp_in_third], ['Inferred Solar Cell QE', 'NIST Photodiode QE', 'Longpass Inserted'])
        ...
        axarr_QE[0,0].legend(PD_plots + SC_plots,  ['Photodiode photocurrent - ' + cell_id for cell_id in cell_ids] + ['Solar cell photocurrent - ' + cell_id for cell_id in cell_ids]  )
